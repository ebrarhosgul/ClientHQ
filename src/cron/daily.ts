/**
 * The wired list `/api/cron/daily` hands to the runner: the seven sweeps in
 * order, with their live gateways (spec 0017, Build plan; spec 0019, AC-20).
 */
